<div class="space-y-8">
    ...
    <div>
        ...
        <p class="text-sm leading-relaxed text-muted-foreground">Only 1 in 3 referred families complete intake. The current paper-based process is long, confusing, and loses families before they ever get help.</p>
    </div>
